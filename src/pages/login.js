            ...
            >
              <div class="flex flex-col space-y-1">
                ...
                <input
                  ...
                  id="email"
                  autofocus
                  class="px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-teal-200"
                  //react hook form
                  {...register("email", {
              ...
              <div class="flex flex-col space-y-1">
                <div class="flex items-center justify-between">
                  ...
                  <a
                    href="#"
                    class="text-sm text-teal-600 hover:underline focus:text-teal-800"
                  >
                    Forgot Password?
                  </a>
                </div>
